CREATE TABLE
    IF NOT EXISTS last_block_height (height INTEGER NOT NULL DEFAULT 0);

INSERT
OR IGNORE INTO last_block_height (height)
VALUES
    (0);

/* DEFAULT VALUES WHERE NOT EXISTS (SELECT 1 FROM last_block_height);*/
CREATE TABLE
